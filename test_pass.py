...
class TestPass(unittest.TestCase):
    ...
    def setUp(self):
        ...
        """
        self. new_password = Password("Codewars","levertco","1234")
    ...
    def test_new_pass(self):
        ...
        """
        self.assertEqual(self.new_password.account,"Codewars")
        self.assertEqual(self.new_password.username,"levertco")
    ...
    def test_display_pass(self):
        ...
        """
        self.new_password.save_pass()
        new_pass = Password("Codewars","1234",Password.generate_pass(9))
        new_pass.save_pass()
    ...
    def test_delete(self):
        ...
        """
        self.new_password.save_pass()
        new_pass = Password("Codewars","1234",Password.generate_pass(8))
        new_pass.save_pass()
        Password.delete_password("Codewars")
        self.assertEqual(len(Password.passwords),1)
    ...
    def test_pass_exist(self):
        ...
        """
        self.new_password.save_pass()
        self.assertTrue(Password.password_exist("codewars"))
